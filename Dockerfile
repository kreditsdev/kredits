...
RUN set -ex && \
    ldd /src/build/release/bin/kreditsd
...
# Create kredits user
RUN adduser --system --group --disabled-password kredits && \
	mkdir -p /wallet /home/kredits/.kredits && \
	chown -R kredits:kredits /home/kredits/.kredits && \
	chown -R kredits:kredits /wallet

# Contains the blockchain
VOLUME /home/kredits/.kredits
